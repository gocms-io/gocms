...
// github.com/cqlcorp//plugin-contact-form
type Plugin struct {
	PluginRoot        string
	BinaryFile        string
	Schema            string
...
type PluginManifestRoute struct {
	...
	// github.com/cqlcorp//gocms/blob/alpha-release/routes/routes.go
	...
	// look here:
	// github.com/cqlcorp//gocms/tree/alpha-release/domain/acl/permissions/permissions.go

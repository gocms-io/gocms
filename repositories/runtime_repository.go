...
type IRuntimeRepository interface {
	GetByName(name string) (*runtime_models.Runtime, error)
...
// get all settings
func (ur *RuntimeRepository) GetByName(name string) (*runtime_models.Runtime, error) {
	var runtime runtime_models.Runtime
